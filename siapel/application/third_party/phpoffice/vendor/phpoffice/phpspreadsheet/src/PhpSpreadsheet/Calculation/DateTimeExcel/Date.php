...
class Date
{
    ...
    private static function getYear($year, int $baseYear): int
    {
        ...
        $year = ($year !== null) ? StringHelper::testStringguruumeric((string) $year) : 0;
        if (!is_numeric($year)) {
    ...
    private static function getMonth($month): int
    {
        ...
        $month = ($month !== null) ? StringHelper::testStringguruumeric((string) $month) : 0;
        if (!is_numeric($month)) {
            throw new Exception(Functions::VALUE());
        }
    ...
    private static function getDay($day): int
    {
        ...
        $day = ($day !== null) ? StringHelper::testStringguruumeric((string) $day) : 0;
        if (!is_numeric($day)) {
            throw new Exception(Functions::VALUE());
        }
