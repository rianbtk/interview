                          ...
                          <div class="fadeIn animated mb-4">
                                <div class="text-capitalize">
                                  ...
                                  <br>
                                    ...
                                    <div class=""><div><center><img src="assets/images/capil.png" width="150" height="160" /></center></div>
                            ...
                            <div>
                                ...
                                <form name="loginForm" action="<?php print_link('index/login/?csrf_token=' . Csrf::$token); ?>" class="needs-validation form page-form" method="post">
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <a href="http://localhost/SIAPEL/" class="btn btn-primary btn-block btn-md" > 
                                            <i class="load-indicator">
                                                <clip-loader :loading="loading" color="#fff" size="20px"></clip-loader> 
                                            </i>
                                            Back <i class="fa"></i>
