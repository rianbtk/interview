<div id="topbar" class="navbar navbar-expand-md fixed-top navbar-green bg-green">
    <div class="container-fluid">
            ...
            <a class="navbar-brand img-responsive left" href="http://localhost/SIAPEL/">HOME</a>
            <?php 
        ...
        if(user_login_status() == true ){ 
        ?>
        <nav id="sidebar" class="navbar-green bg-green">
